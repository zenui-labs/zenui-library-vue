...
<template>
  <section
      class="max-w-[1330px] mx-auto mt-8 px-6 640px:px-8 1024px:px-10 1404px:px-0 w-full pt-[2.5rem] p-6 min-h-screen relative">

    <div
        class='w-[50px] bg-[#3fb682] h-[600px] absolute top-[-100px] opacity-50 640px:opacity-100 640px:top-[-150px] right-[250px] rotate-[70deg] dark:blur-[120px] blur-[100px]'></div>

    <div class='max-w-[800px] text-gray-800'>
      <h1 class="text-3xl 1024px:text-4xl font-bold mb-4 text-[#3fb682]">Privacy Policy for ZenUI
        Library Vue</h1>
      <p class="mb-4 text-gray-500 dark:text-darkTextColor">Effective Date: January
        1, {{ date.getFullYear() }}</p>

      <p class="mb-4 dark:text-darkSubTextColor text-gray-500">
        Welcome to ZenUI Library Vue. Your privacy is important to us. This Privacy Policy outlines how we
        collect, use, and protect your personal information when you use our services, including our
        website, UI components library, and tools.
      </p>

      <h2 class="text-2xl font-semibold dark:text-darkTextColor mb-2 mt-10">1. Information We Collect</h2>
      <p class="mb-4 dark:text-darkSubTextColor text-gray-500">
      ...
      <h2 class="text-2xl font-semibold dark:text-darkTextColor mb-2 mt-10">2. How We Use Your
        Information</h2>
      <p class="mb-4 dark:text-darkSubTextColor text-gray-500">
      ...
      <h2 class="text-2xl font-semibold dark:text-darkTextColor mb-2 mt-10">3. Sharing Your
        Information</h2>
      <p class="mb-4 dark:text-darkSubTextColor text-gray-500">
        We do not sell or rent your personal information to third parties. We may share your information
        with:
      </p>
      <ul class="list-disc list-inside mb-4 dark:text-darkSubTextColor text-gray-500">
      ...
      <h2 class="text-2xl font-semibold dark:text-darkTextColor mb-2 mt-10">4. Data Security</h2>
      <p class="mb-4 dark:text-darkSubTextColor text-gray-500">
        We implement appropriate technical and organizational measures to protect your personal information
        against unauthorized access, alteration, disclosure, or destruction.
      </p>

      <h2 class="text-2xl font-semibold mb-2 dark:text-darkTextColor mt-10">5. Your Rights</h2>
      <p class="mb-4 dark:text-darkSubTextColor text-gray-500">
      ...
      <h2 class="text-2xl font-semibold mb-2 dark:text-darkTextColor mt-10">6. Third-Party Links</h2>
      <p class="mb-4 dark:text-darkSubTextColor text-gray-500">
      ...
      <h2 class="text-2xl font-semibold mb-2 dark:text-darkTextColor mt-10">7. Changes to This Privacy
        Policy</h2>
      <p class="mb-4 dark:text-darkSubTextColor text-gray-500">
      ...
      <h2 class="text-2xl font-semibold mb-2 dark:text-darkTextColor mt-10">8. Contact Us</h2>
      <p class="mb-4 dark:text-darkSubTextColor text-gray-500">
        If you have any questions or concerns about this Privacy Policy or our data practices, please
        contact us at:
      </p>
      <p class="mb-4 dark:text-darkSubTextColor text-gray-500">
        Email: <a href='mailto:zenuilibrary@gmail.com' class='!text-brandColor'>zenuilibrary@gmail.com</a>
      </p>

      <p class='dark:text-darkSubTextColor '>By using Zenui Library Vue, you agree to the terms outlined in
