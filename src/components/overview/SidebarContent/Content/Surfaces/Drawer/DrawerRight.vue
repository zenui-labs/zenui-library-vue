...
<template>
  ...
  <div
    ...
    class="w-full h-screen fixed bg-[rgb(0,0,0,0.2)] top-0 left-0 z-[200000000] dark:bg-black/40 transition-all duration-300"
  >
    <div
      :class="
        openDrawer
    ...
    >
      ...
      <div class="w-full flex items-end p-4 justify-end">
        <Icon
          icon="rx:cross-1"
          class="p-2 w-fit dark:text-slate-400 dark:hover:bg-slate-900/50 text-[2.5rem] hover:bg-[#e7e7e7] rounded-full transition-all duration-300 cursor-pointer"
        ...
        >
          ...
          >
            ...
            <div class="flex items-center gap-12">
              ...
              >
                ${{ product.price }}
                <span class="text-primary pl-1">${{ product.sale }}</span>
              </h3>
              <Icon
                icon="rx:cross-1"
