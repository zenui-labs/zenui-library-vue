...
<template>
  <div
    class="w-full 640px:w-[80%] 1024px:w-[60%] shadow-md h-[350px] transition-all duration-300 overflow-hidden rounded-md dark:bg-slate-800 relative cursor-pointer group flex items-center justify-center flex-col gap-[10px]"
  >
