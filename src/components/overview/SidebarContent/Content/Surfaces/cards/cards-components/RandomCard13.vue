...
<template>
  <div class="p-8 mb-4 flex items-center gap-5 justify-center">
    <div
        class="w-full bg-white dark:bg-slate-800 1024px:max-w-[60%] boxShadow rounded-lg"
    >
      ...
      <div class="p-4">
        ...
        <div
            class="mt-8 flex 640px:flex-row flex-col gap-[15px] 640px:gap-[5px] 640px:items-center justify-between w-full"
        >
          <h3
