...
<template>
  <div class="p-8 mb-4 flex items-center gap-5 justify-center">
    <div
      class="w-full 1024px:w-[60%] shadow-lg bg-white dark:bg-slate-800 rounded"
    >
      <!-- Cover Image -->
      <div
      ...
      <!-- Stats -->
      <div
        class="w-full p-4 mt-8 border-t dark:border-slate-700 border-border flex items-center justify-between"
      >
