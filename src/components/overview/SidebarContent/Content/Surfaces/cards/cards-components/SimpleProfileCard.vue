...
<template>
  <div class="p-8 mt-20 mb-4 flex items-center gap-5 justify-center">
    <div
      class="w-full 1024px:w-[60%] mt-16 1024px:mt-0 dark:bg-slate-800 shadow-lg rounded flex flex-col"
    >
      <!-- Profile Image -->
      ...
      <!-- Description -->
      <div>
        <div class="w-full start mt-3 px-2">
          <h2 class="font-[600] dark:text-[#abc2d3] text-center text-[1.4rem]">
            Description
          </h2>
          <p class="text-text dark:text-[#abc2d3] text-[0.9rem] text-center">
        ...
        <!-- Stats Section -->
        <div
          class="w-full p-4 mt-8 border-t dark:border-slate-600 border-border flex items-center justify-between"
        >
