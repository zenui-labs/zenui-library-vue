...
<template>
  <div class="p-8 mb-4 flex items-center gap-5 justify-center">
    <div
      class="bg-white dark:bg-slate-800 rounded-md boxShadow w-full 1024px:min-w-[70%] 1024px:max-w-[80%]"
    >
      <img
      ...
      <div class="p-4 relative">
        ...
        <p class="text-[1rem] dark:text-[#abc2d3]/90 text-gray-300 mt-6">
          Performance
        </p>
        <h1
        ...
        <div class="mt-5 flex items-center gap-[10px]">
          <span
            class="w-[40px] dark:border-slate-500 cursor-pointer h-[40px] rounded-full border border-[#959393] flex items-center justify-center"
          >
            <Icon
              icon="material-symbols:bookmark-outline"
              class="text-[#959393] dark:text-[#abc2d3]"
            />
          </span>
          <span
            class="w-[40px] dark:border-slate-500 cursor-pointer h-[40px] rounded-full border border-[#959393] flex items-center justify-center"
