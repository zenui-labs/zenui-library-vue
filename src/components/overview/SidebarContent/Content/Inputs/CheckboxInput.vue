...
import {
  animatedCheckboxCodes,
  groupCheckboxCodes,
  normalCheckboxCodes
} from "@/components/overview/SidebarContent/Content/Inputs/PreviewCodes/CheckboxInputPreviewCodes.js";
...
const normalCheckboxPreview = ref(true);
const normalCheckboxCode = ref(false);

const animatedCheckboxPreview = ref(true);
const animatedCheckboxCode = ref(false);

const checkboxGroupPreview = ref(true);
const checkboxGroupCode = ref(false);
...
<template>
  ...
  >
    <div>
      <WarningMessageCard>
        Customize your checkboxes by changing their colors and sizes. Adjust the
        <b>background-color</b> for the unchecked state and
      ...
      <ToggleTab
          :preview="normalCheckboxPreview"
          @update:preview="(val) => (normalCheckboxPreview = val)"
          @update:code="(val) => (normalCheckboxCode = val)"
          :code="normalCheckboxCode"
      />

      <ComponentWrapper>
        <div
            v-if="normalCheckboxPreview"
        ...
        <ShowCode v-else :code="normalCheckboxCodes"/>
      </ComponentWrapper>
      ...
      <ToggleTab
          :preview="animatedCheckboxPreview"
          @update:preview="(val) => (animatedCheckboxPreview = val)"
          @update:code="(val) => (animatedCheckboxCode = val)"
          :code="animatedCheckboxCode"
      />

      <ComponentWrapper>
        <div
            v-if="animatedCheckboxPreview"
            class="p-8 pt-12 mb-4 flex items-center flex-col gap-5 justify-center"
        >
          <label class="flex items-center gap-[10px] cursor-pointer">
            <input
        ...
        <ShowCode v-else :code="animatedCheckboxCodes"/>
      </ComponentWrapper>
      ...
      <ToggleTab
          ...
          @update:preview="(val) => (checkboxGroupPreview = val)"
          @update:code="(val) => (checkboxGroupCode = val)"
          :code="checkboxGroupCode"
      />

      <ComponentWrapper>
        <div
            v-if="checkboxGroupPreview"
        ...
        <ShowCode v-else :code="groupCheckboxCodes"/>
      </ComponentWrapper>

      <OverviewFooter
          backName="Number Input"
    ...
    <ContentNavbar
        classs="w-[70%]"
        :contents="checkboxInputContents"
