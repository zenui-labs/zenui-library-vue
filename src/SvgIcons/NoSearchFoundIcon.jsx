    ...
    return (
        <svg width="54" height="55" viewBox="0 0 54 55" fill="none" xmlns="http://www.w3.org/2000/svg">
            <path
                ...
                fill="#141B34"></path>
            <path opacity="0.4" d="M4.5 22.75L15.75 22.7501" stroke="#141B34" strokeWidth="3.375"
                  strokeLinecap="round" strokeLinejoin="round"></path>
            <path d="M4.5 38.5H15.75" stroke="#141B34" strokeWidth="3.375" strokeLinecap="round"
                  strokeLinejoin="round"></path>
            <path opacity="0.4" d="M4.5 7H42.75" stroke="#141B34" strokeWidth="3.375"
                  strokeLinecap="round" strokeLinejoin="round"></path>
        </svg>
    );
};
