...
<template>
  <footer :class="`w-full max-w-[${props.width}] mt-8`">
    <div
        ...
        :class="`${isBackButton ? 'justify-between' : 'justify-end'} flex items-center w-full py-4`"
    >
      <RouterLink
          v-if="isBackButton"
          :to="backUrl"
    ...
    >
      ...
      <div class="flex items-center gap-3">
        ...
        <a
            href="https://ko-fi.com/zenuilibrary"
            target="_blank"
            rel="noreferrer"
            class="bg-[#FFDD00] flex items-center gap-2 py-1.5 px-3 rounded-normal text-[0.9rem] font-medium"
        >
          <img
